...
ActiveRecord::Schema.define(version: 2020_01_27_083831) do
  ...
  create_table "catalog_items_catalogs", id: false, force: :cascade do |t|
    ...
    t.index ["catalog_id", "catalog_item_id"], name: "index_catalog_items_catalogs_on_catalog_id_and_catalog_item_id", unique: true
  end
